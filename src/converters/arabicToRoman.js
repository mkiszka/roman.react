...
function arabicToRoman(arabic) {
    ...
    if (arabic > 3999) return "The maximum roman number is 3999";
    let roman = "";
    ...
    for (let index = 0; index < decimalParts.length; index++) {
        ...
        if (element !== 0 || index !== 0) {
            roman = singlePositionArabicToRoman(element, findMinimalDivisorIndex(element)) + roman;
        }
